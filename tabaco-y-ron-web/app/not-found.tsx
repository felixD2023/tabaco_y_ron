...
export default function NotFound() {
  return (
    <section className="page relative flex min-h-[78vh] items-center overflow-hidden bg-coal">
      {/* Halo de humo / brasa de fondo */}
      <div
        className="pointer-events-none absolute inset-0 z-0"
        style={{
          background:
            "radial-gradient(circle at 70% 25%, rgba(200,169,106,0.08), transparent 42%), radial-gradient(circle at 15% 80%, rgba(185,28,28,0.06), transparent 45%)",
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(45deg, rgba(200,169,106,0.04) 0 1px, transparent 1px 16px)",
        }}
      />
      ...
      <div className="container-tr relative z-[2] py-20 md:py-28">
        <div className="fade-up mx-auto max-w-[760px] text-center">
          ...
          <div
            className="font-serif leading-none text-gold/90"
            style={{ fontSize: "clamp(96px, 22vw, 260px)", letterSpacing: "-0.03em" }}
          >
            404
          </div>
          ...
          <p className="mx-auto mt-7 max-w-[480px] text-[15px] leading-[1.65] text-cream-mute md:text-lg">
            La dirección que buscabas no existe o se ha movido. Pero la casa sigue
            abierta: el catálogo, las marcas y el ritual te esperan donde siempre.
          </p>
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-[11px] uppercase tracking-[0.2em] text-muted">
