...
// Reveal hook + component — IntersectionObserver-driven scroll animations
...
function Reveal({ children, as = 'div', direction = 'up', delay = 0, className = '', style = {} }) {
...
// Parallax y simple — modula transform por scroll
...
Object.assign(window, {
  useViewport, useReveal, useParallax, Reveal,
  Logo, Monogram, TopBar, Footer,
